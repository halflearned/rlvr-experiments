...
async def main() -> None:
    ...
    num_epochs = 40  # Number of weight sync cycles
    iterations_per_epoch = 5  # Training iterations before syncing weights
    sync_reference_every = 2  # Sync reference model every N epochs
