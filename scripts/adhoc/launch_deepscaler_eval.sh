#!/bin/bash
# Launch DeepScaleR pass@k evaluation across 8 GPUs
...
SCRIPT="/efs/rlvr-experiments/scripts/adhoc/deepscaler_passk_eval.py"
OUTPUT_DIR="/efs/rlvr-experiments/experiments/deepscaler_passk"
LOG_DIR="/tmp/deepscaler_eval"

mkdir -p "$OUTPUT_DIR"
mkdir -p "$LOG_DIR"

echo "Starting DeepScaleR evaluation on 8 GPUs..."
...
python /efs/rlvr-experiments/scripts/adhoc/compute_passk.py --results-dir "$OUTPUT_DIR"
