#!/usr/bin/env python3
"""
Aggregate results from deepscaler_passk_eval.py and compute pass@k.

Usage:
    python scripts/adhoc/compute_passk.py --results-dir /efs/rlvr-experiments/experiments/deepscaler_passk
"""
...
def main():
    ...
    parser.add_argument("--results-dir", type=str, default="/efs/rlvr-experiments/experiments/deepscaler_passk")
